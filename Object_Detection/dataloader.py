...
def normalize_bbox(bbox, orig_size, target_size, stride):
    ...
    return grid_x0, grid_y0, grid_x1, grid_y1, grid_cx, grid_cy, l, t, r, b
...
class SARDet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for anno in annotations:
            ...
            category_id = anno['category_id']
            grid_x0, grid_y0, grid_x1, grid_y1, grid_cx, grid_cy, l, t, r, b = normalize_bbox(bbox, orig_size, self.target_size, self.stride)
